...
public class App {
	...
	public App(String[] args) throws IOException {
		...
		if (!searchIsEmpty()) {
			if (ConnectionHelper.ins.checkStatus(searchParam) == 200) {
				if (singleSearch()) {
					writeMovieResultToCsv(ConnectionHelper.ins.getEntity());
				} else {
					writeListOfMoviesToCsv(ConnectionHelper.ins.getEntity());
				}
			}
		}
	}
	...
	private void writeMovieResultToCsv(HttpEntity entity) throws ParseException, IOException {
